...
1. **Retrieve context from Dewey** (before updating the constitution):

   Query Dewey for relevant context:
   - Use `dewey_semantic_search` with "project constitution principles governance" to find how other projects in the org have structured their constitutions
   - Use `dewey_search` for any prior constitution versions or governance discussions

   Use retrieved context to align with org-wide patterns where applicable.
   If Dewey is unavailable, proceed directly to step 2.
